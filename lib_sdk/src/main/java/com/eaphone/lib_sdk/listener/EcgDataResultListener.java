...
public interface EcgDataResultListener {
    ...
    /**
     * 腿温
     * @param thigh_temperature 腿温
     */
    void onThighTemperatureResult(String thigh_temperature);

    /**
     *实时波行数据返回
     * @param time 监测时长
     * @param ecgData ecg波形数据
     * @param ppg1Data ppg1波形数据
     * @param ppg2Data ppg2波形数据
     */
    void onDataResult(long time, List<Integer> ecgData, List<Integer> ppg1Data, List<Integer> ppg2Data);
